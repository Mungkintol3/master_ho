              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  ...
                  <form id="updatenilai" method="post" action="#" class="form-horizontal">
                    ...
                    <div class="form-group">
                      <input type="text" name="nilai" id="nilai" placeholder="Enter Nilai Pegawai" class="form-control">
                    </div>
  ...
  <script type="text/javascript">
      $(function(){
          ...
          $("#updatenilai").on('submit',function(e){
            var nama , id , id_user , npk , tgl  , nilai ;
            ...
            if(document.getElementById('npk').value == "" ){
              ...
              $.ajax({
                ...
                method : "POST" ,
                data : "id=" + id + "&id_user=" + id_user + "&nama=" + nama + "&npk="+ npk + "&nilai=" + nilai + "&tgl=" + tgl  ,
                beforeSend : function(){
